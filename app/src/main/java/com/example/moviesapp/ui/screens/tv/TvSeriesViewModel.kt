...
class TvSeriesViewModel @Inject constructor(
    ...
    private val getDiscoverAllTvSeriesUseCase: GetDiscoverAllTvSeriesUseCase,
    ...
    private val tvSeriesState: StateFlow<TvSeriesState> =
        deviceLanguage.mapLatest { deviceLanguage ->
            TvSeriesState(
                ...
                discover = getDiscoverAllTvSeriesUseCase(deviceLanguage)
                    .cachedIn(viewModelScope),
                topRated = getTopRatedTvSeriesUseCase(deviceLanguage)
                    .cachedIn(viewModelScope),
                trending = getTrendingTvSeriesUseCase(deviceLanguage)
                    .cachedIn(viewModelScope),
                airingToday = getAiringTodayTvSeriesUseCase(deviceLanguage)
                    .cachedIn(viewModelScope)
            )
